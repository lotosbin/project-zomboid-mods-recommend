...
项目的核心参考模组合集为 **[bin^2的B42.13合集](https://steamcommunity.com/sharedfiles/filedetails/?id=3624259825)**，这是一个精心挑选的B42.14.1兼容模组集合，包含101个高质量的模组（85+个核心模组，已剔除补丁类依赖项），涵盖了界面增强、本地化、系统功能、游戏机制、角色外观、音频娱乐、修复健康等多个类别。
...
**最近更新**：2026年1月28日 - 完成了全面的模组更新检查。更新了合集中的模组数量（从93个增加到101个），新增8个模组。更新了各分类目录的模组信息，添加了新模组的详细描述。
## 📁 目录结构
