...
欢迎来到Project Zomboid模组列表！本仓库收集整理了各种优质模组信息，为您的僵尸末日生存体验增添更多乐趣。
...
项目的核心参考模组合集为 **[bin^2的B42.13.2合集](https://steamcommunity.com/sharedfiles/filedetails/?id=3624259825)**，这是一个精心挑选的B42.13-B42.15兼容模组集合，包含123个高质量的模组（80+个核心模组，已剔除补丁类依赖项），涵盖了界面增强、本地化、系统功能、游戏机制、角色外观、音频娱乐、修复健康等多个类别。

### 合集分类概览

该合集包含以下类别的模组（新增类别用*标记）：

- **界面增强类模组** (17个) - UI重设计、交互优化、状态显示、食物交互、技能追踪、收藏管理、装备界面、嵌套容器、服务器设置、上下文菜单图标
...
- **生存和环境类模组** (7个) - 睡眠系统、环境视觉效果、地图模组、出生点、冬季倒计时
...
**最近更新**：2026年3月12日 - 完成了全面的模组更新检查。更新了合集中的模组数量（从101个增加到123个），新增22个模组。更新了各分类目录的模组信息，添加了新模组的详细描述。
## 📁 目录结构
...
Akyrohunter创作的一系列高质量的"传说"(Legendary)系列模组，为Project Zomboid添加了各种传说级别的物品和装备。
...
这些模组专注于改变Project Zomboid中角色的外观和体型，提供更多样化的角色定制选项，让玩家能够创建更符合个人喜好的角色形象。

| 模组名称 | Workshop ID | 链接 | 类别 | 状态 |
|---------|------------|------|------|------|
| [B42] VSGirlBody v3.1 (42.131) | 待补充 | [链接待补充] | 角色体型 | ✅ 兼容B42.13.1 |

[查看更多角色/外观类模组](./character-appearance/README.md)

## 🎵 音频和娱乐类模组

这些模组专注于增强Project Zomboid的音频体验和娱乐功能，为游戏添加更多沉浸式声音效果和音乐内容。
...
这些模组专注于修复Project Zomboid游戏机制中的问题和不便之处，提供更流畅的游戏体验。

| 模组名称 | Workshop ID | 链接 | 类别 | 状态 |
|---------|------------|------|------|------|
| CookingSync - Multiplayer Cooking Fix [v5.0] | 3773820803 | [链接待补充] | 多人烹饪修复 | ✅ 兼容B42 |
| Rip All Clothes | 3782616137 | [链接待补充] | 衣物撕裂 | ✅ 兼容B42多人游戏 |

[查看更多游戏机制修复类模组](./game-mechanics-fixes/README.md)

## 🏥 健康系统类模组

这些模组专注于增强Project Zomboid的健康和疾病系统，提供更真实、更深入的健康管理体验。

| 模组名称 | Workshop ID | 链接 | 类别 | 状态 |
|---------|------------|------|------|------|
| [B42.13]Realistic Disease Mod | 3804257569 | [链接待补充] | 疾病系统 | ✅ 兼容B42.13 |

[查看更多健康系统类模组](./health-system/README.md)
...
截至2023年12月，Akyrohunter正在努力更新整个传说系列以兼容Build 42.14.1。部分模组已更新，其他模组将在近期跟进。由于个人时间限制，更新可能需要一些时间。

**重要更新**：bin^2的B42.13合集已确认与Build 42.14.1完全兼容，所有101个模组在最新版本中均可正常运行。

## 🤝 贡献

欢迎提交更多模组信息或更新现有文档！如果您发现任何错误或有改进建议，请随时提出。
